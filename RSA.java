...
public class RSA {
	...
	public byte[] encryptMessage(byte[] message) {
		System.out.println((new BigInteger(message)).modPow(e, N));
	...
	public byte[] decryptMessage(byte[] message) {
		System.out.println((new BigInteger(message)).modPow(d, N));

		System.out.println((new BigInteger(message)).modPow(d, N).toByteArray());
		return message;
	}
}
